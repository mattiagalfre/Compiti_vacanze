...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    exchanged = exchange_money(budget, exchange_rate + spread_percent)
    num_of_bills = get_number_of_bills(exchanged, denomination)
...
def non_exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    change = get_change(exchanged, exchangeable)
    return int(change)
